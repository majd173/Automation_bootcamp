...
@app.route('/owners')
def owners():
    return render_template('owners.html_projects')


@app.route('/pets')
def pets():
    return render_template('pets.html_projects')
...
def add_owner():
    if request.method == 'POST':
        ...
        return render_template('add_owner.html_projects', error=str(e))
    return render_template('add_owner.html_projects')
...
def add_pet():
    if request.method == 'POST':
        ...
        return render_template('pets.html_projects', error=str(e))
    return render_template('pets.html_projects')
