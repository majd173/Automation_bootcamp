...
from selenium_ui_projects.solarsystemscope.logic.online_apps_page import OnlineAppsPage
from selenium_ui_projects.solarsystemscope.logic.day_light_map_page import DayLightMapPage
